...
int main(int argc, char *argv[])
{
    ...
    // }
    {
        // This is a pointer point to .rodata on RAM
        // char *ptr = "hello";
        // ptr[1] = 5; // compile will get segfault because cannot write to ro memory
        // "hello" is string literal is copied to the str which lives on stack data segment
        char str[] = "hello";
        str[1] = '2';
        printf("%s", str);
    }
