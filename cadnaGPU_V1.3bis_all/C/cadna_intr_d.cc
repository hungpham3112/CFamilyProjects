...
{ 
 ...
 double_st fabsf(const  double_st& a) 
{ 
   double_st res; 
   if(a.x >= 0.){ 
     res.x = a.x; 
...
//  /
 ...
 double_st floorf(const  double_st& a) 
{ 
     double_st res; 
    res.x = floor(a.x); 
    res.y = floor(a.y); 
...
//  /
 ...
 double_st ceilf(const  double_st& a) 
{ 
     double_st res; 
    res.x = ceil(a.x); 
    res.y = ceil(a.y); 
...
//  /
 ...
 double_st truncf(const  double_st& a) 
{  
     double_st res; 
    res.x = trunc(a.x); 
    res.y = trunc(a.y); 
...
{  
     double_st res; 
    cerr << "CADNA WARNING: the nearbyint function is not CADNA compatible" << endl; 
    res.x = nearbyint(a.x); 
    res.y = nearbyint(a.y); 
    res.z = nearbyint(a.z); 
    res.accuracy=DIGIT_NOT_COMPUTED; 
...
//       (according to the prevailing rounding mode) in doubleing-point
//       format.
//      
//    INPUTS
//      a           - double_st
...
//  /
 ...
 double_st rintf(const  double_st& a) 
{  
     double_st res; 
    cerr << "CADNA WARNING: the rint function is not CADNA compatible" << endl; 
    res.x = rint(a.x); 
    res.y = rint(a.y); 
    res.z = rint(a.z); 
    res.accuracy=DIGIT_NOT_COMPUTED; 
...
//      "invalid" doubleing-point exception is raised. A range error
...
long int lrintf(const  double_st& a) 
{  
...
long long int llrintf(const  double_st& a) 
{  
