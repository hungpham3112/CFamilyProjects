...
//////////////////////////////////////////////////////////
void float_st::display(const char *s) const 
{ 
  char t[40]="";
...
ostream& operator <<(ostream& s, const float_st &a) 
{
  char ch[64];
  return s << a.str(ch);
}
...
istream& operator >>(istream& s, float_st& a)
{
  float d;
  s >> d;
  a.x = d;
