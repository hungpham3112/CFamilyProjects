...
#define PACKAGE_STRING "CADNA GPU"
...
const char* _cadna_cancel_err_msg    = "LOSS OF ACCURACY DUE TO CANCELLATION(S)";
...
void  cadna_init(int max_instability, unsigned int tag, unsigned int seed, unsigned int cancellation)
{
  ...
  if ((tag & CADNA_DIV) || ! max_instability)  _cadna_div_tag=0; 
  if ((tag & CADNA_MUL) || ! max_instability)  _cadna_mul_tag=0; 
  if ((tag & CADNA_POWER) || ! max_instability)  _cadna_power_tag=0; 
  if ((tag & CADNA_MATH) || ! max_instability)  _cadna_math_tag=0; 
  if ((tag & CADNA_INTRINSIC) || ! max_instability) _cadna_intrinsic_tag=0; 
  if ((tag & CADNA_CANCEL) ||  ! max_instability)  _cadna_cancel_tag=0; 
  if ((tag & CADNA_BRANCHING) || ! max_instability)  _cadna_branching_tag=0; 
  cout << "----------------------------------------------------------------" << endl;
    
  cout << PACKAGE_STRING << " software" << endl;
...
void cadna_end()
{
  ...
  cout << "----------------------------------------------------------------" << endl;
  cout << PACKAGE_STRING << " software" << endl;
  sum= _cadna_div_count+_cadna_mul_count+_cadna_math_count+
...
void cadna_disable(unsigned int v)
{
  if (_cadna_div_tag & CADNA_DIV){ 
    if (_cadna_div_tag) _cadna_div_change=1;
    _cadna_div_tag=0;
  }
  
  if (_cadna_mul_tag & CADNA_MUL){ 
    if (_cadna_mul_tag) _cadna_mul_change=1;
    _cadna_mul_tag=0;
  }

  if (_cadna_power_tag & CADNA_POWER){ 
    if (_cadna_power_tag) _cadna_power_change=1;
    _cadna_power_tag=0;
  }
  
  if (_cadna_branching_tag & CADNA_BRANCHING){ 
    if (_cadna_branching_tag) _cadna_branching_change=1;
    _cadna_branching_tag=0;
  }

  if (_cadna_cancel_tag & CADNA_CANCEL){ 
    if (_cadna_cancel_tag) _cadna_cancel_change=1;
    _cadna_cancel_tag=0;
  }
  
  if (_cadna_intrinsic_tag & CADNA_INTRINSIC){ 
    if (_cadna_intrinsic_tag) _cadna_intrinsic_change=1;
    _cadna_intrinsic_tag=0;
  }
  
  if (_cadna_math_tag & CADNA_MATH){ 
    if (_cadna_math_tag) _cadna_math_change=1;
    _cadna_math_tag=0;
  }
}
