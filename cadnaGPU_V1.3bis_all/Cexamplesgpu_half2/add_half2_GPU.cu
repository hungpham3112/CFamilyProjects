...
__device__ void sub()
{
	...
	*/
	...
	b = 3.f;
	half2 res_a, res_b;
	res_a = __float2half2_rn(a);
	res_b = __float2half2_rn(b);
	
	__half2 res = __hsub2(res_a, res_b);
	
	printf("a = %f, b = %f, low = %f, high = %f, low+high = %f\n",a, b, __low2float(res), __high2float(res), __low2float(res)+__high2float(res));
