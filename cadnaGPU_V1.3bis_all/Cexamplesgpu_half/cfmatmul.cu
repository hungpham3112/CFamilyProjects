...
int main()
{
    ...
    printf("calcul  kernel SM temps: %f\n",t2-t1);
    printf("temps: %f   GFLOPS %f \n",t2-t1, (float)DIMMAT*DIMMAT*DIMMAT/(t2-t1)/1.e9);
    printf("apres  le  kernel\n");
