...
////////////////////////////////////////////////////////////////////////////////
// declaration, forward
template <class T, class U> T runTest(int argc, char **argv, ReduceType datatype, T* data);
...
int main(int argc, char **argv) {
  ...
  for (int seed = 1; seed < 11; seed++) {
      ...
      double_st gpu_result_double = (double_st)0.0;
        gpu_result_double = runTest<double_st, double_gpu_st>(argc, argv, datatype,data1);
      ...
      float_st gpu_result_float = (float_st)0.0f;  // Initialize outside the switch
        gpu_result_float = runTest<float_st, float_gpu_st>(argc, argv, datatype,data2);
...
template <class T, class U> T runTest(int argc, char **argv, ReduceType datatype, T* random_data) {
  int size = 1 << 15;   // number of elements to reduce
  std::cout << "Size: " << size << std::endl;
  int maxThreads = 32; // number of threads per block
  int whichKernel = 0;
  int maxBlocks = 1024;
